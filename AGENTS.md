...
- Required validation for code changes: run `npm test` and `npm run build`. The current baseline is 39 tests across eight test files; update this count here only when it materially helps orientation.
